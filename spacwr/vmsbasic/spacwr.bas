...
3850 H=INT((K(I,3)/FND(0))*(2+RND)) \ S=S-H
...
4960 GOTO 5010
4970 REM PRINT "YOU ARE AT QUADRANT ( ";Q1;",";Q2;" ) SECTOR ( ";S1;",";S2;" )"
4990 REM INPUT "SHIP AND TARGET COORDINATES ARE:"; C1,A,W1,X
5010 X=X-A \ A=C1-W1
...
5300 REM IF A$="YES" THEN 4970
5310 IF A$<>"NO" THEN 5280
5320 GOTO 1270
5321 REM *** END OF LIBRARY COMPUTER CODE
5380 R1=INT(RND*8+1) \ R2=INT(RND*8+1) \ A$="   " \ Z1=R1 \ Z2=R2
5430 GOSUB 5680
...
6495 PRINT "      ENTERPRISE AND ALL KLINGONS IN YOUR QUADRANT"
6500 GOTO 230
6510 END
